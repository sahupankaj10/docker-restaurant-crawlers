...
class RettyKuchikomiDB(DeclarativeBase):
    ...
    kuchikomi_url   = Column('クチコミURL', String(100), comment="kuchikomi_url")
...
class TabelogUserDB(DeclarativeBase):
    ...
    day_total_rating        = Column('昼評価d', String(10), comment="ay_total_rating", nullable=True, default='null')
    day_culinary_rating     = Column('(昼)day_culinary_rating', String(10), comment="料理・味", nullable=True, default='null')
