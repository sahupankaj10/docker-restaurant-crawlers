...
class RettyKuchikomiDB(DeclarativeBase):
    ...
    num_of_likes    = Column('いいね件数', SmallInteger, comment="num_of_likes", nullable=True, default='null')
...
class RettyFacilityDB(DeclarativeBase):
    ...
    num_of_likes    = Column('いいね件数', SmallInteger, comment="num_of_likes", nullable=True, default='null')
    num_of_interested   = Column('行きたい件数', SmallInteger, comment="num_of_interested", nullable=True, default='null')
    store_popularity    = Column('人気店★数', SmallInteger, comment="store_popularity", nullable=True, default='null')
    ...
    recommended_rate    = Column('オススメ度(％)', SmallInteger, comment="recommended_rate", nullable=True, default='null')
    num_of_persons_went = Column('行った人', Integer, comment="num_of_persons_went", nullable=True, default='null')
    recommended_rate_excellent = Column('オススメ度　excellent', SmallInteger, comment="recommended_rate_excellent", nullable=True, default='null')
    recommended_rate_good      = Column('オススメ度 Good', SmallInteger, comment="recommended_rate_good", nullable=True, default='null')
    recommended_rate_average   = Column('オススメ度 Average', SmallInteger, comment="recommended_rate_average", nullable=True, default='null')
    recommended_num_of_people  = Column('おすすめ人数', Integer, comment="recommended_num_of_people", nullable=True, default='null')
    ...
    number_of_photo = Column('写真', Integer, comment="number_of_photo", nullable=True, default='null')
    number_of_reviews = Column('すべてのクチコミ', Integer, comment="number_of_reviews", nullable=True, default='null')
    reviews_for_lunch = Column('ランチのクチコミ', Integer, comment="reviews_for_lunch", nullable=True, default='null')
    reviews_for_dinner= Column('ディナーのクチコミ', Integer, comment="reviews_for_dinner", nullable=True, default='null')
    ...
    home_page       = Column('お店のホームページ', VARCHAR(100), comment="home_page", nullable=True, default='null')
    facebook_url    = Column('FacebookのURL', VARCHAR(100), comment="facebook_url", nullable=True, default='null')
    banquet_capacity= Column('宴会収容人数', Integer, comment="banquet_capacity", nullable=True, default='null')
...
class TripAdvisorKuchikomiDB(DeclarativeBase):
    ...
    number_of_posts     = Column('投稿数', Integer, comment="number_of_posts", nullable=True, default='null')
    number_of_likes     = Column('いいね数', SmallInteger, comment="number_of_likes", nullable=True, default='null')
    ...
    total_score         = Column('総合評価', Float, comment="total_score", nullable=True, default='null')
    food_score          = Column('食事', Float, comment="food_score", nullable=True, default='null')
    service_score       = Column('サービス', Float, comment="service_score", nullable=True, default='null')
    price_score         = Column('価格', Float, comment="price_score", nullable=True, default='null')
    atmosphere_score    = Column('雰囲気', Float, comment="atmosphere_score", nullable=True, default='null')
    post_useful         = Column('役にたった', Integer, comment="post_useful", nullable=True, default='null')
...
class TripAdvisorFacilityDB(DeclarativeBase):
    ...
    overall_rating      = Column('総合評価', Float, comment="overall_rating", nullable=True, default='null')
    number_of_reviews   = Column('クチコミ数', Integer, comment="number_of_reviews", nullable=True, default='null')
    ...
    official_site       = Column('公式サイト', String(100), comment="official_site", nullable=True, default='null')
    very_good_score     = Column('とても良い', Float, comment="very_good_score", nullable=True, default='0')
    good_score          = Column('良い', Float, comment="good_score", nullable=True, default='0')
    average_score       = Column('普通', Float, comment="average_score", nullable=True, default='0')
    bad_score           = Column('悪い', Float, comment="bad_score", nullable=True, default='0')
    very_bad_score      = Column('とても悪い', Float, comment="very_bad_score", nullable=True, default='0')
    ...
    details                  = Column('詳細', String(20), comment="details", nullable=True, default='null')
...
class TabelogUserDB(DeclarativeBase):
    ...
    night_total_rating      = Column('夜評価', Float, comment="night_total_rating", nullable=True, default='null')
    night_culinary_rating   = Column('(夜)料理・味', Float, comment="night_culinary_rating", nullable=True, default='null')
    night_service_rating    = Column('(夜)サービス', Float, comment="night_service_rating", nullable=True, default='null')
    night_atmosphere_rating = Column('(夜)雰囲気', Float, comment="night_atmosphere_rating", nullable=True, default='null')
    night_cp_rating         = Column('(夜)CP', Float, comment="night_cp_rating", nullable=True, default='null')
    night_drink_rating      = Column('(夜)酒・ドリンク', Float, comment="night_drink_rating", nullable=True, default='null')
    night_amount            = Column('(夜)使った金額（1人）', String(50), comment="night_amount", nullable=True, default='null')
    day_total_rating        = Column('昼評価d', Float, comment="ay_total_rating", nullable=True, default='null')
    day_culinary_rating     = Column('(昼)day_culinary_rating', Float, comment="料理・味", nullable=True, default='null')
    day_service_rating      = Column('(昼)サービス', Float, comment="day_service_rating", nullable=True, default='null')
    day_atmosphere_rating   = Column('(昼)雰囲気', Float, comment="day_atmosphere_rating", nullable=True, default='null')
    day_cp_rating           = Column('(昼)CP', Float, comment="day_cp_rating", nullable=True, default='null')
    day_drink_rating        = Column('(昼)酒・ドリンク', Float, comment="day_drink_rating", nullable=True, default='null')
...
class TabelogKuchikomiDB(DeclarativeBase):
    ...
    day_drink_rating        = Column('(昼)酒・ドリンク', Float, comment="day_drink_rating", nullable=True, default='null')
    day_amount              = Column('(昼)使った金額（1人）', String(50), comment="day_amount", nullable=True, default='null')
    review_liked        = Column('いいね件数', Integer, comment="review_liked", nullable=True, default='0')
...
class TabelogFacilityDB(DeclarativeBase):
    ...
    store_name          = Column('店舗名', String(100), comment="store_name", nullable=True, default='null')
    overall_rating      = Column('総合評価点数', Float, comment="overall_rating", nullable=True, default='null')
    night_total_rating  = Column('夜点数', Float, comment="night_total_rating", nullable=True, default='null')
    day_total_rating    = Column('昼点数', Float, comment="day_total_rating", nullable=True, default='null')
    number_of_reviews   = Column('クチコミ件数', Integer, comment="number_of_reviews", nullable=True, default='null')
    number_of_photo     = Column('写真', Integer, comment="number_of_photo", nullable=True, default='null')
    menu                = Column('口コミに含まれるメニュー', Text, comment="menu", nullable=True, default='null')
    nearest_station     = Column('最寄り駅', Text, comment="nearest_station", nullable=True, default='null')
    genre               = Column('ジャンル', Text, comment="genre", nullable=True, default='null')
    ...
    awards_selection_history = Column('受賞・選出歴', String(20), comment="awards_selection_history", nullable=True, default='null')
    ...
    smoking                 = Column('禁煙・喫煙	駐車場', String(100), comment="smoking", nullable=True, default='null')
    ...
    home_page               = Column('ホームページ', String(100), comment="home_page", nullable=True, default='null')
    official_account        = Column('公式アカウント', String(100), comment="official_account", nullable=True, default='null')
