...
class RettyFacilityDB(DeclarativeBase):
    ...
    home_page       = Column('お店のホームページ', String(100), comment="home_page", nullable=True, default='null')
    facebook_url    = Column('FacebookのURL', String(100), comment="facebook_url", nullable=True, default='null')
